...
def display_figure_grid(
    figures, n_rows, n_cols, fig_width=None, fig_height=None, img_format="png"
):
    images = [
        f.to_image(img_format, width=fig_width, height=fig_height) for f in figures
    ]
